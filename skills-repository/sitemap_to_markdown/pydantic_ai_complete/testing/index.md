...
date: 2026-01-03T23:40:14.191025
---
...
Unless you're really sure you know better, you'll probably want to follow roughly this strategy:
  ...
  - Use [`TestModel`](../api/models/test/#pydantic_ai.models.test.TestModel "TestModel

  
      dataclass
  ") or [`FunctionModel`](../api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel

  
      dataclass
  ") in place of your actual model to avoid the usage, latency and variability of real LLM calls
  - Use [`Agent.override`](../api/agent/#pydantic_ai.agent.Agent.override "override") to replace an agent's model, dependencies, or toolsets inside your application logic
  - Set [`ALLOW_MODEL_REQUESTS=False`](../api/models/base/#pydantic_ai.models.ALLOW_MODEL_REQUESTS "ALLOW_MODEL_REQUESTS
...
The simplest and fastest way to exercise most of your application code is using [`TestModel`](../api/models/test/#pydantic_ai.models.test.TestModel "TestModel
...
The resulting data won't look pretty or relevant, but it should pass Pydantic's validation in most cases. If you want something more sophisticated, use [`FunctionModel`](../api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel
...
Here's how we would write tests using [`TestModel`](../api/models/test/#pydantic_ai.models.test.TestModel "TestModel
...
test_weather_app.py
  ...
  2. This is a safety measure to make sure we don't accidentally make real requests to the LLM while testing, see [`ALLOW_MODEL_REQUESTS`](../api/models/base/#pydantic_ai.models.ALLOW_MODEL_REQUESTS "ALLOW_MODEL_REQUESTS

  
      module-attribute
  ") for more details.
  3. We're using [`Agent.override`](../api/agent/#pydantic_ai.agent.Agent.override "override") to replace the agent's model with [`TestModel`](../api/models/test/#pydantic_ai.models.test.TestModel "TestModel
...
To fully exercise `weather_forecast`, we need to use [`FunctionModel`](../api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel
...
test_weather_app2.py
  ...
  1. We define a function `call_weather_forecast` that will be called by `FunctionModel` in place of the LLM, this function has access to the list of [`ModelMessage`](../api/messages/#pydantic_ai.messages.ModelMessage "ModelMessage

  
      module-attribute
  ")s that make up the run, and [`AgentInfo`](../api/models/function/#pydantic_ai.models.function.AgentInfo "AgentInfo
  ...
  3. We use [`FunctionModel`](../api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel
...
If you're writing lots of tests that all require model to be overridden, you can use [pytest fixtures](https://docs.pytest.org/en/6.2.x/fixture.html) to override the model with [`TestModel`](../api/models/test/#pydantic_ai.models.test.TestModel "TestModel
