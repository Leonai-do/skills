---
url: https://ai.pydantic.dev/api/retries/
date: 2026-01-03T23:40:49.311210
---
...
`config` |  `RetryConfig` |  The arguments to use for the tenacity `retry` decorator, including retry conditions, wait strategy, stop conditions, etc. See the tenacity docs for more info. |  _required_  
