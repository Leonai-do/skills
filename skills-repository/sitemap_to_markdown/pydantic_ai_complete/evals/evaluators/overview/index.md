---
url: https://ai.pydantic.dev/evals/evaluators/overview/
date: 2026-01-03T23:41:58.153621
---
...
---|---|---  
[`EqualsExpected`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EqualsExpected "EqualsExpected

  
      dataclass
  ") | Exact output match | Structured data, classification  
[`Equals`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.Equals "Equals

  
      dataclass
  ") | Equals specific value | Checking for sentinel values  
[`Contains`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.Contains "Contains

  
      dataclass
  ") | Substring/element check | Required keywords, PII detection  
[`IsInstance`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.IsInstance "IsInstance

  
      dataclass
  ") | Type validation | Format validation  
[`MaxDuration`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.MaxDuration "MaxDuration

  
      dataclass
  ") | Performance threshold | SLA compliance  
[`HasMatchingSpan`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.HasMatchingSpan "HasMatchingSpan
...
Use [`LLMJudge`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge "LLMJudge
...
Case-specific evaluators are one of the most powerful features for building comprehensive evaluation suites. You can attach evaluators to individual [`Case`](../../../api/pydantic_evals/dataset/#pydantic_evals.dataset.Case "Case
...
A particularly powerful pattern is using case-specific [`LLMJudge`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge "LLMJudge
...
Pydantic Evals handles both automatically. Use async when: \- Making API calls \- Running database queries \- Performing I/O operations \- Calling LLMs (like [`LLMJudge`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge "LLMJudge
...
If an evaluator raises an exception, it's captured as an [`EvaluatorFailure`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluatorFailure "EvaluatorFailure
