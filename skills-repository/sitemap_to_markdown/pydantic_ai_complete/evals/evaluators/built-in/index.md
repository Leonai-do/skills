---
url: https://ai.pydantic.dev/evals/evaluators/built-in/
date: 2026-01-03T23:41:52.967273
---
...
**Returns:** [`EvaluationReason`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluationReason "EvaluationReason
...
**Parameters:**
  ...
  - `query` ([`SpanQuery`](../../../api/pydantic_evals/otel/#pydantic_evals.otel.SpanQuery "SpanQuery")): Query to match against spans
  - `evaluation_name` (str | None): Custom name for this evaluation in reports
...
[`LLMJudge`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge "LLMJudge
