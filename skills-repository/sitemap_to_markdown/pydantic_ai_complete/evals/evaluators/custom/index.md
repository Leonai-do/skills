---
url: https://ai.pydantic.dev/evals/evaluators/custom/
date: 2026-01-03T23:41:57.055042
---
...
All evaluators inherit from [`Evaluator`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.Evaluator "Evaluator

  
      dataclass
  ") and must implement `evaluate`:
...
**Key Points:**
  ...
  - Return `bool`, `int`, `float`, `str`, [`EvaluationReason`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluationReason "EvaluationReason
...
Each key in the returned dictionary becomes a separate result in the report. Values can be:
  ...
  - [`EvaluationReason`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluationReason "EvaluationReason
...
The [`EvaluatorOutput`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluatorOutput "EvaluatorOutput

  
      module-attribute
  ") type represents all legal values that can be returned by an evaluator, and can be used as the return type annotation for your custom `evaluate` method.
