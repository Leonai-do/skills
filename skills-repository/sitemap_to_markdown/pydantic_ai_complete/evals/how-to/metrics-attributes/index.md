---
url: https://ai.pydantic.dev/evals/how-to/metrics-attributes/
date: 2026-01-03T23:42:03.874486
---
...
Use [`increment_eval_metric`](../../../api/pydantic_evals/dataset/#pydantic_evals.dataset.increment_eval_metric "increment_eval_metric") to track numeric values:
...
Use [`set_eval_attribute`](../../../api/pydantic_evals/dataset/#pydantic_evals.dataset.set_eval_attribute "set_eval_attribute") to store any data:
...
Metrics and attributes are available in the [`EvaluatorContext`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluatorContext "EvaluatorContext
...
In addition to case-level metadata, you can also pass experiment-level metadata when calling [`evaluate()`](../../../api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset.evaluate "evaluate
...
[Learn about Gateway](../../../gateway)
    ...
    agent = Agent('gateway/openai:gpt-5-mini', model_settings={'temperature': 0.7})
