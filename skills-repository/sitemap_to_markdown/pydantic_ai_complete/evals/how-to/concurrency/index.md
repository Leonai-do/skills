---
url: https://ai.pydantic.dev/evals/how-to/concurrency/
date: 2026-01-03T23:42:02.272651
---
...
If your evaluators are expensive (e.g., [`LLMJudge`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge "LLMJudge

  
      dataclass
  ")), limiting concurrency helps manage: \- API rate limits \- Cost (fewer concurrent API calls) \- Memory usage
