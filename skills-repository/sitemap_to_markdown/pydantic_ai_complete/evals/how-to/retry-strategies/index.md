---
url: https://ai.pydantic.dev/evals/how-to/retry-strategies/
date: 2026-01-03T23:42:07.549077
---
...
Retry configurations use [Tenacity](https://tenacity.readthedocs.io/) and support the same options as Pydantic AI's [`RetryConfig`](../../../api/retries/#pydantic_ai.retries.RetryConfig "RetryConfig"):
...
If an evaluator fails after all retries, it's recorded as an [`EvaluatorFailure`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluatorFailure "EvaluatorFailure
