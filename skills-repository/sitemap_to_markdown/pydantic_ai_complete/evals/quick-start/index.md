...
date: 2026-01-03T23:41:52.801066
---
...
Understanding a few core concepts will help you get the most out of Pydantic Evals:
  ...
  - **[`Dataset`](../../api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset "Dataset")** \- A collection of test cases and (optional) evaluators
  - **[`Case`](../../api/pydantic_evals/dataset/#pydantic_evals.dataset.Case "Case

  
      dataclass
  ")** \- A single test scenario with inputs and optional expected outputs and case-specific evaluators
  - **[`Evaluator`](../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.Evaluator "Evaluator

  
      dataclass
  ")** \- A function that scores or validates task outputs
