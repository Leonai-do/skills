---
url: https://ai.pydantic.dev/models/huggingface/
date: 2026-01-03T23:42:40.292878
---
...
You can then use [`HuggingFaceModel`](../../api/models/huggingface/#pydantic_ai.models.huggingface.HuggingFaceModel "HuggingFaceModel
...
By default, the [`HuggingFaceModel`](../../api/models/huggingface/#pydantic_ai.models.huggingface.HuggingFaceModel "HuggingFaceModel

  
      dataclass
  ") uses the [`HuggingFaceProvider`](../../api/providers/#pydantic_ai.providers.huggingface.HuggingFaceProvider) that will select automatically the first of the inference providers (Cerebras, Together AI, Cohere..etc) available for the model, sorted by your preferred order in https://hf.co/settings/inference-providers.
