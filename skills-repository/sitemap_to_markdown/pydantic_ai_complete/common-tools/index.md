---
url: https://ai.pydantic.dev/common-tools/
date: 2026-01-03T23:39:57.591183
---
...
To use [`duckduckgo_search_tool`](../api/common_tools/#pydantic_ai.common_tools.duckduckgo.duckduckgo_search_tool "duckduckgo_search_tool"), you need to install [`pydantic-ai-slim`](../install/#slim-install) with the `duckduckgo` optional group:
...
To use [`tavily_search_tool`](../api/common_tools/#pydantic_ai.common_tools.tavily.tavily_search_tool "tavily_search_tool"), you need to install [`pydantic-ai-slim`](../install/#slim-install) with the `tavily` optional group:
