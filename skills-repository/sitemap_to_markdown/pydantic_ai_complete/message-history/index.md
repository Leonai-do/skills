...
date: 2026-01-03T23:40:08.786688
---
...
Both [`RunResult`](../api/agent/#pydantic_ai.agent.AgentRunResult "AgentRunResult

  
      dataclass
  ") (returned by [`Agent.run`](../api/agent/#pydantic_ai.agent.AbstractAgent.run "run

  
      async
  "), [`Agent.run_sync`](../api/agent/#pydantic_ai.agent.AbstractAgent.run_sync "run_sync")) and [`StreamedRunResult`](../api/result/#pydantic_ai.result.StreamedRunResult "StreamedRunResult

  
      dataclass
  ") (returned by [`Agent.run_stream`](../api/agent/#pydantic_ai.agent.AbstractAgent.run_stream "run_stream
...
On [`StreamedRunResult`](../api/result/#pydantic_ai.result.StreamedRunResult "StreamedRunResult
...
**Note:** The final result message will NOT be added to result messages if you use [`.stream_text(delta=True)`](../api/result/#pydantic_ai.result.StreamedRunResult.stream_text "stream_text

  
      async
  ") since in this case the result content is never built as one string.

Example of accessing methods on a [`RunResult`](../api/agent/#pydantic_ai.agent.AgentRunResult "AgentRunResult
...
Example of accessing methods on a [`StreamedRunResult`](../api/result/#pydantic_ai.result.StreamedRunResult "StreamedRunResult
...
To use existing messages in a run, pass them to the `message_history` parameter of [`Agent.run`](../api/agent/#pydantic_ai.agent.AbstractAgent.run "run

  
      async
  "), [`Agent.run_sync`](../api/agent/#pydantic_ai.agent.AbstractAgent.run_sync "run_sync") or [`Agent.run_stream`](../api/agent/#pydantic_ai.agent.AbstractAgent.run_stream "run_stream
...
We export [`ModelMessagesTypeAdapter`](../api/messages/#pydantic_ai.messages.ModelMessagesTypeAdapter "ModelMessagesTypeAdapter
...
The `history_processors` is a list of callables that take a list of [`ModelMessage`](../api/messages/#pydantic_ai.messages.ModelMessage "ModelMessage
...
History processors can optionally accept a [`RunContext`](../api/tools/#pydantic_ai.tools.RunContext "RunContext

  
      dataclass
  ") parameter to access additional information about the current run, such as dependencies, model information, and usage statistics:
...
You can test what messages are actually sent to the model provider using [`FunctionModel`](../api/models/function/#pydantic_ai.models.function.FunctionModel "FunctionModel
