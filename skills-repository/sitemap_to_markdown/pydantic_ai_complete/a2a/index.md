...
date: 2026-01-03T23:39:51.793608
---
...
Given the nature of the A2A protocol, it's important to understand the design before using it, as a developer you'll need to provide some components:
  ...
  - [`Storage`](../api/fasta2a/#fasta2a.Storage "Storage"): to save and load tasks, as well as store context for conversations
  - [`Broker`](../api/fasta2a/#fasta2a.Broker "Broker

  
      dataclass
  "): to schedule tasks
  - [`Worker`](../api/fasta2a/#fasta2a.Worker "Worker
...
FastA2A allows you to bring your own [`Storage`](../api/fasta2a/#fasta2a.Storage "Storage"), [`Broker`](../api/fasta2a/#fasta2a.Broker "Broker

  
      dataclass
  ") and [`Worker`](../api/fasta2a/#fasta2a.Worker "Worker
...
The [`Storage`](../api/fasta2a/#fasta2a.Storage "Storage") component serves two purposes:
...
Since the goal of `to_a2a` is to be a convenience method, it accepts the same arguments as the [`FastA2A`](../api/fasta2a/#fasta2a.FastA2A "FastA2A") constructor.
