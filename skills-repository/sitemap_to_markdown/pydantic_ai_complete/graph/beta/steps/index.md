...
date: 2026-01-03T23:42:25.888381
---

# Steps

Steps are the fundamental units of work in a graph. They're async functions that receive a [`StepContext`](../../../api/pydantic_graph/beta_step/#pydantic_graph.beta.step.StepContext "StepContext
...
Steps are created using the [`@g.step`](../../../api/pydantic_graph/beta_graph_builder/#pydantic_graph.beta.graph_builder.GraphBuilder.step "step") decorator on the [`GraphBuilder`](../../../api/pydantic_graph/beta_graph_builder/#pydantic_graph.beta.graph_builder.GraphBuilder "GraphBuilder
...
Every step function receives a [`StepContext`](../../../api/pydantic_graph/beta_step/#pydantic_graph.beta.step.StepContext "StepContext

  
      dataclass
  ") as its first parameter. The context provides access to:
...
In addition to regular steps that return a single value, you can create streaming steps that yield multiple values over time using the [`@g.stream`](../../../api/pydantic_graph/beta_graph_builder/#pydantic_graph.beta.graph_builder.GraphBuilder.stream "stream") decorator:
...
The beta graph API provides strong type checking through generics. Type parameters on [`StepContext`](../../../api/pydantic_graph/beta_step/#pydantic_graph.beta.step.StepContext "StepContext
