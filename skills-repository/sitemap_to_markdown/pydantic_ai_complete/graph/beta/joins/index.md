---
url: https://ai.pydantic.dev/graph/beta/joins/
date: 2026-01-03T23:42:25.318151
---
...
When you use [parallel execution](../parallel/) (broadcasting or mapping), you often need to collect and combine the results. Join nodes serve this purpose by:
  ...
  2. Aggregating their outputs using a [`ReducerFunction`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReducerFunction "ReducerFunction
...
[`reduce_list_append`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.reduce_list_append "reduce_list_append") collects all inputs into a list:
...
[`reduce_list_extend`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.reduce_list_extend "reduce_list_extend") extends a list with an iterable of items:
...
[`reduce_dict_update`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.reduce_dict_update "reduce_dict_update") merges dictionaries together:
...
[`reduce_null`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.reduce_null "reduce_null") discards all inputs and returns `None`. Useful when you only care about side effects:
...
[`reduce_sum`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.reduce_sum "reduce_sum") sums numeric values:
...
[`ReduceFirstValue`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReduceFirstValue "ReduceFirstValue

  
      dataclass
  ") returns the first value it receives and cancels all other parallel tasks. This is useful for "race" scenarios where you want the first successful result:
...
Create custom reducers by defining a [`ReducerFunction`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReducerFunction "ReducerFunction
...
Reducers with access to [`ReducerContext`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReducerContext "ReducerContext

  
      dataclass
  ") can call [`ctx.cancel_sibling_tasks()`](../../../api/pydantic_graph/beta_join/#pydantic_graph.beta.join.ReducerContext.cancel_sibling_tasks "cancel_sibling_tasks") to cancel all other parallel tasks in the same fork. This is useful for early termination when you've found what you need:
