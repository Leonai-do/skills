---
url: https://ai.pydantic.dev/graph/beta/parallel/
date: 2026-01-03T23:42:25.577524
---
...
The convenience method [`add_mapping_edge()`](../../../api/pydantic_graph/beta_graph_builder/#pydantic_graph.beta.graph_builder.GraphBuilder.add_mapping_edge "add_mapping_edge") provides a simpler syntax:
...
The transform function receives a [`StepContext`](../../../api/pydantic_graph/beta_step/#pydantic_graph.beta.step.StepContext "StepContext

  
      dataclass
  ") with the current inputs and has access to state and dependencies. This is useful for:
